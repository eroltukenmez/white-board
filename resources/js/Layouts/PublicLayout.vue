...
const menus = ref([
    { title:'Home',name:'welcome' },
    { title:'Application',name:'application.index' }
])
            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink v-for="menu in menus" :href="route(menu.name)" :active="route().current(menu.name)">
                                    {{ menu.title }}
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink v-for="menu in menus" :href="route(menu.name)" :active="route().current(menu.name)">
                            {{ menu.title }}
                        </ResponsiveNavLink>
                    </div>
